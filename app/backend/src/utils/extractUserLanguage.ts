...
// Extract 'Accept-Language' of user from 'req'

import { Request } from "express";

const extractUserLanguage = (req: Request): string => {
  const userLanguageString: string | undefined = req.get('Accept-Language');

  return userLanguageString?.trim() ?? "";
};

export { extractUserLanguage };