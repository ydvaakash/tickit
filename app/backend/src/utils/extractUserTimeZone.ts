...
// Extract timezone of user from 'req.headers'

import { Request } from "express";

const extractUserTimeZone = (req: Request): string => {
  const userTimeZone: string | undefined = req.get('X-User-Timezone');

  return userTimeZone?.trim() ?? "";
}

export { extractUserTimeZone };