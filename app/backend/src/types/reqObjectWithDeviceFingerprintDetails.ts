...
// Type for 'req' object after including device fingerprint details

import { Request } from "express";

interface reqObjectWithDeviceFingerprintDetails extends Request {
  userDeviceFingerprintDetails?: {
...
export { reqObjectWithDeviceFingerprintDetails };